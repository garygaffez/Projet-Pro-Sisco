<footer class="bg-secondary footerHeight">
    <div class="container">
        <div class="row justify-content-center p-3">
            <div class="col-12 col-sm-4 col-md-3 col-lg-2 d-flex m-0 justify-content-center">
                <a href="" class="text-decoration-none linkColor">Accueil</a>                
            </div>
            <div class="col-12 col-sm-4 col-md-3 col-lg-2 d-flex p-0 m-0 justify-content-center">
                <!-- Button trigger modal -->
                <a href="" class="text-decoration-none linkColor" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Mentions légales</a>
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="exampleModalLabel">Mentions légales</h5>
                    ...
                    <div class="modal-body">
                        ...
                        Sisco Vaux sur Somme

                        Responsable éditorial : Hugo ESSIQUE

                        1 rue du Calvaire, 80800 VAUX SUR SOMME
            ...
            <div class="col-12 col-sm-4 col-md-3 col-lg-2 d-flex p-0 m-0 justify-content-center text-white">2022</div>
            <div class="col-12 col-sm-4 col-md-3 col-lg-2 d-flex p-0 m-0 justify-content-center">
                <a href="https://www.facebook.com/search/top?q=sisco%20vaux%20sur%20somme" target="_blank"><img src="/assets/img/social-facebook-button-blue-icon_resize.png" class="img-fluid" alt=""></a>
            </div>
