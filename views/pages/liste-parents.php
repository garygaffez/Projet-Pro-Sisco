        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 d-flex    justify-content-between">                                                    
                    <form action="<?=htmlspecialchars($_SERVER['PHP_SELF'])?>" method="GET" class="mt-3" id="form">
                        ...
                        <input type="search" class="" name="search" placeholder="rechercher" pattern="<?=REG_STR_NO_NUMBER?>" value="<?=$search ?? ''?>" >
        ...
        <nav aria-label="pagination">
            ...
            <ul class="pagination d-flex justify-content-center mt-3">
                ...
                <li class="page-item ">
                    <?php
                    if ($page > 1) {?>
                        <a href="?page=<?php echo $page - 1;?>&selectPatientNumber=<?=$selectPatientNumber;?>&search=<?=$search;?>" class="page-link">Page précédente</a>
                    <?php
                    }
                    ?>
                </li>
                ...
                <li class="page-item">
                    <?php
                        for ($i = $page - 2; $i <= $page - 1; $i++) {                    
                            if ($i > 0 && $i < $nbPages) {?>
                                <a href="?page=<?php echo $i;?>&selectPatientNumber=<?=$selectPatientNumber;?>&search=<?=$search;?>" class="page-link"><?php echo $i;?></a>
                            <?php
                            }
                        }
                    ?>
                ...
                <li class="page-item active">
                    <a href="?page=<?php echo $page;?>&selectPatientNumber=<?=$selectPatientNumber;?>&search=<?=$search;?>" class="page-link"><?php echo $page;?></a>
                </li>
                ...
                <li class="page-item">
                    <?php
                    if ($page < $nbPages) {?>
                        <a href="?page=<?php echo $page + 1;?>&selectPatientNumber=<?=$selectPatientNumber;?>&search=<?=$search;?>" class="page-link">Page suivante</a>
                    <?php
                    }
                    ?>
                </li>
                ...
                <?php
                    ...
                    foreach ($parents as $parent) {?>
                        <tr>
                            ...
                            <td><a href="mailto:gary.gaffez@gmail.com"><?=$parent->mail;?></td>
                            <td><?=$parent->phone;?></td>
                            

                            <td>                                
                                <a href="/controllers/update-user-controller.php?id=<?=$parent->id_user;?>" class="has-text-link">Modifier</a>                                
                            </td>
                            <td>                                
                                <a href="/controllers/delete-user-controller.php?id=<?=$parent->id_user;?>" class="delete"><img src="/assets/img/delete-1-icon.png" class="img-thumbnail" alt=""></a>                                
                            </td>
