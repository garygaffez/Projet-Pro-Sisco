                        ...
                        <div class="container p-0">
                            <div class="row">
                                <div class="col d-flex flex-column">
                                    <?php
                                    if ($childrenByParent instanceof PDOException) { ?>
                                        <p class=""><?= $childrenByParent->getMessage(); ?></p>
                                        <?php
                                    } else {
                                        ...
                                        if (count($childrenByParent) > 0) {
                                            foreach ($childrenByParent as $child) { ?>
                                                ...
                                                <div class="d-flex bd-highlight align-items-center">
                                                    ...
                                                    <div class="ms-1 mb-4 bd-highlight">
                                                        <a href="/controllers/ajout-cantine-controller.php?id=<?= $child->id_child; ?>" class="btn btn-primary btn-sm mt-4 fw-bold rounded-pill ">Inscrire à la cantine</a>
